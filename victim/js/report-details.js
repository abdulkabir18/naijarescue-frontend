...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    //             type: "Accident",
    //             confidence: 0.92,
    //             status: "Reported", // Changed to test cancel button visibility
    //             coordinates: { latitude: 6.4474, longitude: 3.5405 },
    //             address: {
    //                 street: "Lekki-Epe Expressway",
    //                 city: "Lagos",
    ...
    function renderReport(r) {
                ...
                <div class="details-body">
                    ...
                    <div class="right">
                        ...
                        <div class="action-section">
                            <h3>Actions</h3>
                            <button class="btn-cancel" id="cancelIncidentBtn" data-incident-id="${r.id}">
                                <i class="ri-close-circle-line"></i> Cancel Incident
                            </button>
                            <p class="cancel-info">
                                <i class="ri-information-line"></i>
                                You can cancel this incident if no responder has been assigned yet.
                            </p>
                        </div>
                        ` : ''}
                    </div>
        ...
        if (canCancel) {
            ...
            if (cancelBtn) {
                cancelBtn.addEventListener("click", () => handleCancelIncident(r.id));
            }
        }
